...
echo
echo "next steps:"
echo "  1. authenticate with HF (for gated models):"
echo "     hf auth login"
echo "  2. see available models:"
echo "     ./download.sh --list"
echo "  3. download one or more:"
echo "     ./download.sh gemma4-e2b qwen3-0.6b"
echo "  4. run a forward pass:"
echo "     source .venv/bin/activate"
echo "     python -c 'import SuperKittens as sk; import SuperKittens.models.gemma.gemma4;"
echo "                m = sk.load(\"gemma4-e2b\"); print(m.chat(\"Hi\"))'"
