...
class Qwen(Model):
    ...
    def from_spec(cls, spec, **overrides) -> "Qwen":
        ...
        # cache_max_pinned: a caller-set cache_max disables the memory-aware clamp.
        ...
        if not cache_max_pinned and gguf_path and gguf_path.exists():
            ...
            fitted = memory_aware_cache_max(
                ...
                kv_q4k=(bool(os.environ.get("SK_KV_Q4K"))
                        and not os.environ.get("SK_KV_Q8")),
                kv_q4=(bool(os.environ.get("SK_KV_Q4"))
                       and not os.environ.get("SK_KV_Q8")
                       and not os.environ.get("SK_KV_Q4K")),
            )
