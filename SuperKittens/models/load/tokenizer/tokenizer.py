...
class Tokenizer:
    ...
    def from_hf_json(cls, json_path: str, *, family: str = "qwen3") -> "Tokenizer":
        ...
        specials = set()
        # Per-family special-token names. Adding a new family means one row in
        # _FAMILY_SPECIALS; bos/eos/pad detection routes through here so we never
        # heuristic-match `<|turn>` or other family-specific markers as BOS.
