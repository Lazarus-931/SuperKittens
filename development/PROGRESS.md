...
| 43 | mamba2 conv1d O(1) decode-state-carry (replace O(T²) re-prefill) | MED | WIP a09a38f-followup | thread conv_state through conv1d_silu + route L=1 to mamba2_step_ref; from #62 follow-up |
